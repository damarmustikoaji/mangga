...
LABEL name="Boilerplate Robot Framework Ala-ala"
...
RUN wget -q https://dl.google.com/linux/direct/google-chrome-stable_102.0.5005.27-1_amd64.deb \
    && dpkg -i google-chrome*.deb \
    && rm google-chrome*.deb \
    && wget -q https://chromedriver.storage.googleapis.com/102.0.5005.27/chromedriver_linux64.zip \
